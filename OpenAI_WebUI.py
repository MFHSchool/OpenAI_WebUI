...
def main():
    ...
    save_location2 = os.path.join(os.path.dirname(os.path.realpath(sys.path[0])), save_location)
    st.error(f"OAIWUI_SAVEDIR: {os.path.dirname(os.path.realpath(sys.path[0]))}")
